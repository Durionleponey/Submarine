...
export type MessageFragmentFragment = { __typename?: 'Message', _id: string, content: string, createdAt: any, chatId: string, userId: string } & { ' $fragmentName'?: 'MessageFragmentFragment' };
...
export type GetMessagesQuery = { __typename?: 'Query', getMessages: Array<{ __typename?: 'Message', _id: string, content: string, createdAt: any }> };
