...
export type ChatCreatedSubscription = { __typename?: 'Subscription', chatCreated: { __typename?: 'Chat', _id: string, name?: string | null, isPrivate: boolean, userIds: Array<string>, userId: string } };
...
export type UsersQuery = { __typename?: 'Query', users: Array<{ __typename?: 'User', pseudo: string, email: string }> };
