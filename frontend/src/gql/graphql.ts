...
export type Subscription = {
  ...
  chatCreated: Scalars['String']['output'];
...
export type ChatCreatedSubscription = { __typename?: 'Subscription', chatCreated: string };
