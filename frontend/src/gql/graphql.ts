...
export type GetMessagesQuery = { __typename?: 'Query', getMessages: Array<{ __typename?: 'Message', _id: string, content: string, createdAt: any, userPseudo: string, userId: string }> };
